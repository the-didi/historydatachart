<template>
    <div class="add-visitor-container">
        ...
        <a-breadcrumb style="margin-bottom:10px">
            ...
            <a-breadcrumb-item>添加来访信息</a-breadcrumb-item>
        </a-breadcrumb>
        <div class="content">
...
onMounted(()=>{
    ...
    socket.addEventListener('message', function (event: any) {
        ...
        addVisitorEntity.value.visitorName = res.data.name
        addVisitorEntity.value.gender = res.data.gender
        addVisitorEntity.value.idCard = res.data.number
        addVisitorEntity.value.age = (year - Number.parseInt(res.data.birthday.substring(0,4)))+""
