<template>
    <div class="select-content">
        ...
        <div class="handler-left">
            ...
            <a-checkbox-group v-model:value="userStore.currentDisable" style="width:100%">
                <div class="group-items">
                    <div class="item" v-for="item in dataSource">
                        <a-checkbox :value="item.commonDiseasesName">{{ item.commonDiseasesName }}</a-checkbox>
                    </div>
                </div>
            </a-checkbox-group>
...
const loadData = () => {
    ...
    schema.append("commonDiseasesName", searchStr.value)

    fetch("/api/commonDiseases?" + schema, {
        headers: {
